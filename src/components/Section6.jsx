...
import test1 from "../assets/testimonial-01.jpg";
import testSvg1 from "../assets/testimonial-sign-01.svg";
import test2 from "../assets/testimonial-02.jpg";
import testSvg2 from "../assets/testimonial-sign-02.svg";
						...
						<div className='relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row items-center justify-end'>
							...
							>
								<div className='relative max-w-sm mx-auto'>
									...
									></div>
									<Carousel>
										<div className='flex flex-col h-auto shadow-2xl text-left'>
											...
											<div className='grow flex flex-col relative bg-gradient-to-t from-slate-800 to-slate-700 p-6 pt-14'>
												...
												<p className='grow font-medium text-slate-200 mb-4'>
													...
													cards with a new one which makes everything 100 times
													easier. Like Apple Pay, online shopping without
													useless phone confirmation. I wish I knew this
													earlier. ”
												</p>
												<div className='font-medium text-sm text-slate-500'>
													<span className='text-slate-200'>Elisa Koeppel</span>{" "}
													-{" "}
