...
import pricing1 from "../assets/pricing-01.png";
import pricing2 from "../assets/pricing-02.png";
import pricing3 from "../assets/pricing-03.png";
import pricing4 from "../assets/pricing-04.png";
				...
				<div className='max-w-6xl mx-auto px-4 sm:px-6'>
					<div className='py-12 md:py-20'>
						...
						<div className='relative max-w-xl mx-auto md:max-w-none text-center md:text-left'>
							{/* <!-- Section header --> */}
							<div
								className='md:max-w-3xl mb-12 md:mb-20'
								data-aos='fade-up'
							>
